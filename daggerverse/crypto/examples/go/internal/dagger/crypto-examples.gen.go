...
// recipes.
type CryptoExamples struct { // crypto-examples (../../../../../../:0:0)
...
// are derived from it.
func (r *CryptoExamples) GenerateEd25519SshKey() *Directory {
...
func (r *CryptoExamples) GenerateRsaKeypair(opts ...CryptoExamplesGenerateRsaKeypairOpts) *Directory {
...
func (r *CryptoExamples) HashSourceFile(ctx context.Context, opts ...CryptoExamplesHashSourceFileOpts) (string, error) {
...
func (r *CryptoExamples) HashWithSha3(ctx context.Context, opts ...CryptoExamplesHashWithSha3Opts) (string, error) {
...
func (r *Query) CryptoExamples() *CryptoExamples { // crypto-examples (../../../../../../:0:0)
