...
// criteria suggestre-spawns the cluster between Mutate and Query in the same test,
// losing the data the prior Mutate wrote (verified during impl). Every
// method on *Cluster and *Client still carriesown line so any data-returning call re-executes per invocation.
//
