...
// A unique identifier for an object.
type DgraphClientID string

// A unique identifier for an object.
type DgraphClientSecurityID string

// A unique identifier for an object.
type DgraphClusterID string

// A unique identifier for an object.
type DgraphID string

// A unique identifier for an object.
type DgraphServerSecurityID string
...
func (r *Query) LoadDgraphClientFromID(id DgraphClientID) *DgraphClient {
...
func (r *Query) LoadDgraphClientSecurityFromID(id DgraphClientSecurityID) *DgraphClientSecurity {
...
func (r *Query) LoadDgraphClusterFromID(id DgraphClusterID) *DgraphCluster {
...
func (r *Query) LoadDgraphFromID(id DgraphID) *Dgraph {
...
func (r *Query) LoadDgraphServerSecurityFromID(id DgraphServerSecurityID) *DgraphServerSecurity {
