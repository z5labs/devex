...
// among them.
func (r *Pdf) Container() *Container {
...
func (r *Pdf) Document(source *File) *PdfDocument {
...
func (r *Pdf) Merge(sources []*File) *File {
...
// of its own.
func (r *Pdf) RenderSchedulingSelfTest(ctx context.Context) error {
...
func (r *Pdf) Version(ctx context.Context) (string, error) {
	if r.version != nil {
...
func (r *Pdf) WithApkAuth(credentials *Secret) *Pdf {
...
func (r *Pdf) WithApkKey(key *File) *Pdf {
...
// trusts.
func (r *Pdf) WithApkRepository(url string) *Pdf {
...
func (r *Pdf) WithFonts(dir *Directory) *Pdf {
...
type PdfConvert struct { // pdf (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *PdfConvert) Bbox(opts ...PdfConvertBboxOpts) *File {
...
func (r *PdfConvert) Eps() *Directory {
...
func (r *PdfConvert) HTML() *Directory {
...
func (r *PdfConvert) Jpeg() *Directory {
...
func (r *PdfConvert) Png() *Directory {
...
// WithoutAnnotations are ignored: see the note on Ps.
func (r *PdfConvert) Svg() *Directory {
...
func (r *PdfConvert) Text(ctx context.Context, opts ...PdfConvertTextOpts) (string, error) {
	if r.text != nil {
		return *r.text, nil
	}
...
// expects.
func (r *PdfConvert) Tiff() *Directory {
...
func (r *PdfConvert) Txt(opts ...PdfConvertTxtOpts) *File {
...
func (r *PdfConvert) WithColorMode(mode PdfColorMode) *PdfConvert {
...
func (r *PdfConvert) WithConcurrency(concurrency int) *PdfConvert {
...
// dimensions directly.
func (r *PdfConvert) WithDpi(dpi int) *PdfConvert {
...
//
// Ignored by Text and Txt.
func (r *PdfConvert) WithScaleTo(pixels int) *PdfConvert {
...
//
// Ignored by Text and Txt.
func (r *PdfConvert) WithoutAnnotations() *PdfConvert {
...
type PdfDocument struct { // pdf (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *PdfDocument) Attachments() *Directory {
...
func (r *PdfDocument) Convert() *PdfConvert {
...
func (r *PdfDocument) EmbeddedImages(format PdfImageFormat) *Directory {
...
// through Container.
func (r *PdfDocument) Fonts(ctx context.Context) (string, error) {
	if r.fonts != nil {
		return *r.fonts, nil
	}
...
func (r *PdfDocument) Info(ctx context.Context) (string, error) {
	if r.info != nil {
		return *r.info, nil
	}
...
func (r *PdfDocument) Metadata(ctx context.Context) (string, error) {
	if r.metadata != nil {
...
func (r *PdfDocument) PageCount(ctx context.Context) (int, error) {
	if r.pageCount != nil {
...
// any other.
func (r *PdfDocument) Signatures(ctx context.Context) (string, error) {
	if r.signatures != nil {
...
func (r *PdfDocument) Split() *Directory {
...
func (r *PdfDocument) WithOwnerPassword(password *Secret) *PdfDocument {
...
// conversion of it.
func (r *PdfDocument) WithPageRange(first int, last int) *PdfDocument {
...
// for the same reason.
func (r *PdfDocument) WithUserPassword(password *Secret) *PdfDocument {
	assertNotNil("password", password)
...
func (r *Query) Pdf(opts ...PdfOpts) *Pdf { // pdf (../../../../:0:0)
...
// `COLOR`, `GRAY` and `MONO`.
type PdfColorMode string // pdf (../../../../:0:0)
...
type PdfImageFormat string // pdf (../../../../:0:0)
...
const (
	...
	PdfImageFormatAll PdfImageFormat = "ALL"
	...
	PdfImageFormatOriginal PdfImageFormat = "ORIGINAL"
	...
	PdfImageFormatTiff PdfImageFormat = "TIFF"
)
...
type PdfLayoutMode string // pdf (../../../../:0:0)
...
const (
	...
	// their rows.
	PdfLayoutModePhysical PdfLayoutMode = "PHYSICAL"
	...
	// the above.
	PdfLayoutModeRaw PdfLayoutMode = "RAW"
	...
	PdfLayoutModeReading PdfLayoutMode = "READING"
)
