...
// Load a BrunoCollection from its ID.
func (r *Query) LoadBrunoCollectionFromID(id BrunoCollectionID) *BrunoCollection {
	q := r.query.Select("loadBrunoCollectionFromID")
	q = q.Arg("id", id)
...
// Load a Bruno from its ID.
func (r *Query) LoadBrunoFromID(id BrunoID) *Bruno {
	q := r.query.Select("loadBrunoFromID")
	q = q.Arg("id", id)
