...
// the connection.
func (r *Tests) CaCertReachesPrivateCaService(ctx context.Context) error {
...
func (r *Tests) CheckDriftFailsOnAnEndpointAddedToTheSpec(ctx context.Context) error {
...
func (r *Tests) CheckDriftFailsOnBothSidesOfTheRequestSet(ctx context.Context) error {
...
func (r *Tests) CiCheckGatesOnFailingAssertion(ctx context.Context) error {
...
// unrunnable.
func (r *Tests) CiLintFailsBeforeAnyRequest(ctx context.Context) error {
...
func (r *Tests) CiReachesMtlsServiceBehindPrivateCa(ctx context.Context) error {
...
func (r *Tests) CiRedactsSecretVarFromItsReports(ctx context.Context) error {
...
func (r *Tests) CiRejectsUnknownReportFormat(ctx context.Context) error {
...
func (r *Tests) CiRunProducesEveryRequestedReport(ctx context.Context) error {
...
func (r *Tests) CiRunStillReportsWhenTheCollectionFails(ctx context.Context) error {
...
func (r *Tests) CiSecretVarReachesTheCollection(ctx context.Context) error {
...
func (r *Tests) CiShouldNotBeCached(ctx context.Context) error {
...
func (r *Tests) ClientCertAuthenticatesToMtlsService(ctx context.Context) error {
...
// produce it.
func (r *Tests) ClientCertMaterialStaysOutOfTheCollection(ctx context.Context) error {
...
func (r *Tests) ClientCertPassphraseUnlocksTheKey(ctx context.Context) error {
...
func (r *Tests) CsvDataDrivesOneRunPerRow(ctx context.Context) error {
...
func (r *Tests) DataFileWithoutKnownExtensionIsRejected(ctx context.Context) error {
...
func (r *Tests) DriftIgnoresHandWrittenTests(ctx context.Context) error {
...
func (r *Tests) FailingIterationFailsRunAndIsNamedInTheReport(ctx context.Context) error {
...
func (r *Tests) GenerateHonoursOpenCollectionFormat(ctx context.Context) error {
...
func (r *Tests) GenerateProducesRunnableCollection(ctx context.Context) error {
...
func (r *Tests) GenerateRejectsUnknownFormat(ctx context.Context) error {
...
func (r *Tests) JSONDataDrivesOneRunPerRow(ctx context.Context) error {
...
func (r *Tests) JSONEnvFileKeepsItsExtension(ctx context.Context) error {
...
func (r *Tests) LintAcceptsValidCollection(ctx context.Context) error {
...
func (r *Tests) LintRejectsDuplicateSequence(ctx context.Context) error {
...
func (r *Tests) LintRejectsMissingBrunoJSON(ctx context.Context) error {
...
func (r *Tests) LintRejectsPlaintextSecret(ctx context.Context) error {
...
func (r *Tests) LintRejectsUnknownEnvironment(ctx context.Context) error {
...
func (r *Tests) LintRejectsUnresolvedVariable(ctx context.Context) error {
...
func (r *Tests) LintWarnsOnRequestWithoutTests(ctx context.Context) error {
...
func (r *Tests) PassThroughFlagsAreAccepted(ctx context.Context) error {
...
// `run --recursive=false`.
func (r *Tests) RecursiveDefaultReachesSubfolders(ctx context.Context) error {
...
func (r *Tests) ReportEmitsJunitForFailingRun(ctx context.Context) error {
...
// service to find out.
func (r *Tests) ReportRejectsUnknownFormat(ctx context.Context) error {
...
// asked about.
func (r *Tests) ReportShouldNotBeCached(ctx context.Context) error {
...
func (r *Tests) ReportWithoutAllHeadersOmitsEveryHeader(ctx context.Context) error {
...
func (r *Tests) ReportWithoutBodiesOmitsBothBodies(ctx context.Context) error {
...
func (r *Tests) ReportWithoutNamedHeaderKeepsTheOthers(ctx context.Context) error {
...
func (r *Tests) RunFailsOnAssertionFailure(ctx context.Context) error {
...
func (r *Tests) RunPassesAgainstBoundService(ctx context.Context) error {
...
// part of this test.
func (r *Tests) SecretVarIsNotOnArgv(ctx context.Context) error {
...
// cannot keep.
func (r *Tests) SecretVarIsRedactedFromReportsByDefault(ctx context.Context) error {
...
func (r *Tests) TLSControlsAreValidated(ctx context.Context) error {
...
// broken".
func (r *Tests) UnknownEnvironmentIsRejected(ctx context.Context) error {
...
func (r *Tests) VersionReportsPinnedRelease(ctx context.Context) error {
...
func (r *Tests) WithVarOverridesEnvironmentValue(ctx context.Context) error {
...
func (r *Tests) WithoutHeadersRejectsBlankName(ctx context.Context) error {
