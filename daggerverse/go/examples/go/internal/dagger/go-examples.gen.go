...
// recipes.
type GoExamples struct { // go-examples (../../../../../../:0:0)
...
func (r *GoExamples) BuildBinary(opts ...GoExamplesBuildBinaryOpts) *File {
...
func (r *GoExamples) InstallTool(opts ...GoExamplesInstallToolOpts) *File {
...
func (r *GoExamples) ModuleHygiene(opts ...GoExamplesModuleHygieneOpts) *Directory {
...
func (r *GoExamples) TestPackage(ctx context.Context, opts ...GoExamplesTestPackageOpts) (string, error) {
...
func (r *Query) GoExamples() *GoExamples { // go-examples (../../../../../../:0:0)
