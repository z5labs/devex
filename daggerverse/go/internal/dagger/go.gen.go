...
func (r *Go) Build(source *Directory, opts ...GoBuildOpts) *Directory {
...
func (r *Go) Ci(source *Directory) *GoCi {
	assertNotNil("source", source)
	q := r.query.Select("ci")
	q = q.Arg("source", source)
...
func (r *Go) Container(source *Directory) *Container {
	assertNotNil("source", source)
...
// handled.
func (r *Go) CycloneDx(binary *File, source *Directory) *File {
...
func (r *Go) Env(ctx context.Context) (string, error) {
	if r.env != nil {
		return *r.env, nil
	}
...
func (r *Go) Fmt(ctx context.Context, source *Directory) (string, error) {
	assertNotNil("source", source)
	if r.fmt != nil {
		return *r.fmt, nil
	}
...
func (r *Go) Generate(source *Directory, opts ...GoGenerateOpts) *Directory {
	assertNotNil("source", source)
...
func (r *Go) Install(pkg string) *File {
...
func (r *Go) ModDownload(ctx context.Context, source *Directory) error {
	assertNotNil("source", source)
...
func (r *Go) ModTidy(source *Directory) *Directory {
	assertNotNil("source", source)
...
func (r *Go) ModVerify(ctx context.Context, source *Directory) error {
	assertNotNil("source", source)
	if r.modVerify != nil {
		return nil
	}
...
func (r *Go) Run(ctx context.Context, source *Directory, pkg string, opts ...GoRunOpts) (string, error) {
	assertNotNil("source", source)
	if r.run != nil {
		return *r.run, nil
	}
...
func (r *Go) Spdx(binary *File, source *Directory) *File {
	assertNotNil("binary", binary)
	assertNotNil("source", source)
...
func (r *Go) Test(ctx context.Context, source *Directory, opts ...GoTestOpts) (string, error) {
	assertNotNil("source", source)
	if r.test != nil {
		return *r.test, nil
	}
...
func (r *Go) ToolVersion(ctx context.Context) (string, error) {
...
func (r *Go) Vet(ctx context.Context, source *Directory, opts ...GoVetOpts) error {
	assertNotNil("source", source)
	if r.vet != nil {
		return nil
	}
...
// "version").
func (r *Go) Work(ctx context.Context, source *Directory, subcommand string, opts ...GoWorkOpts) (string, error) {
	assertNotNil("source", source)
	if r.work != nil {
		return *r.work, nil
	}
...
func (r *GoCi) Check(ctx context.Context) error {
	if r.check != nil {
		return nil
	}
...
func (r *GoCi) WithBuild(opts ...GoCiWithBuildOpts) *GoCi {
...
func (r *GoCi) WithLint(opts ...GoCiWithLintOpts) *GoCi {
...
func (r *GoCi) WithTest(opts ...GoCiWithTestOpts) *GoCi {
...
type GoBuildMode string // go (../../../../:0:0)
...
const (
	...
	// produces nothing.
	GoBuildModeArchive GoBuildMode = "ARCHIVE"
	...
	GoBuildModeCArchive GoBuildMode = "C_ARCHIVE"
	...
	GoBuildModeCShared GoBuildMode = "C_SHARED"
	...
	GoBuildModeExe GoBuildMode = "EXE"
	...
	GoBuildModePie GoBuildMode = "PIE"
	...
	GoBuildModePlugin GoBuildMode = "PLUGIN"
)
