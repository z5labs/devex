...
func (r *Query) Random() *Random { // random (../../../../:0:0)
...
// adjustment.
func (r *Random) Serial(ctx context.Context, opts ...RandomSerialOpts) (string, error) {
	if r.serial != nil {
		return *r.serial, nil
	}
...
func (r *Random) Sha256(ctx context.Context, opts ...RandomSha256Opts) (string, error) {
	if r.sha256 != nil {
		return *r.sha256, nil
	}
...
func (r *Random) Sha512(ctx context.Context, opts ...RandomSha512Opts) (string, error) {
	if r.sha512 != nil {
		return *r.sha512, nil
	}
...
func (r *Random) UUIDV4(ctx context.Context) (string, error) {
	if r.uuidV4 != nil {
		return *r.uuidV4, nil
	}
...
func (r *Random) UUIDV7(ctx context.Context) (string, error) {
	if r.uuidV7 != nil {
		return *r.uuidV7, nil
	}
