...
type Postgres struct { // postgres (../../../../:0:0)
...
func (r *Postgres) Client(host string, user string, db string, password *Secret, security *PostgresClientSecurity, opts ...PostgresClientOpts) *PostgresClient {
...
func (r *Postgres) Cluster(password *Secret, clientListenerSecurity *PostgresServerSecurity, opts ...PostgresClusterOpts) *PostgresCluster {
	assertNotNil("password", password)
...
func (r *Postgres) MtlsClientSecurity(serverCa *File, clientCert *File, clientKey *Secret) *PostgresClientSecurity {
...
func (r *Postgres) MtlsServerSecurity(serverCert *File, serverKey *Secret, clientCa *File) *PostgresServerSecurity {
...
func (r *Postgres) PlaintextClientSecurity() *PostgresClientSecurity {
...
func (r *Postgres) PlaintextServerSecurity() *PostgresServerSecurity {
...
func (r *Postgres) TLSClientSecurity(serverCa *File) *PostgresClientSecurity {
	assertNotNil("serverCa", serverCa)
...
func (r *Postgres) TLSServerSecurity(serverCert *File, serverKey *Secret) *PostgresServerSecurity {
	assertNotNil("serverCert", serverCert)
	assertNotNil("serverKey", serverKey)
...
// one connection.
type PostgresClient struct { // postgres (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *PostgresClient) ApplyFile(ctx context.Context, file *File) error {
...
func (r *PostgresClient) Exec(ctx context.Context, sql string) (int, error) {
	if r.exec != nil {
		return *r.exec, nil
	}
...
func (r *PostgresClient) Ping(ctx context.Context) error {
	if r.ping != nil {
		return nil
	}
...
// name.
func (r *PostgresClient) QueryJSON(sql string) *File {
...
// "<nil>").
func (r *PostgresClient) Scalar(ctx context.Context, sql string) (string, error) {
	if r.scalar != nil {
		return *r.scalar, nil
	}
...
type PostgresClientSecurity struct { // postgres (../../../../:0:0)
	query *querybuilder.Selection
...
type PostgresCluster struct { // postgres (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *PostgresCluster) BindPrimary(ctr *Container) *Container {
...
func (r *PostgresCluster) Client(security *PostgresClientSecurity) *PostgresClient {
	assertNotNil("security", security)
	q := r.query.Select("client")
	q = q.Arg("security", security)
...
// provisioned with.
func (r *PostgresCluster) Database(ctx context.Context) (string, error) {
	if r.database != nil {
...
func (r *PostgresCluster) Endpoint(ctx context.Context) (string, error) {
	if r.endpoint != nil {
...
func (r *PostgresCluster) Password() *Secret {
...
func (r *PostgresCluster) Stop(ctx context.Context) error {
	if r.stop != nil {
		return nil
	}
...
// with.
func (r *PostgresCluster) User(ctx context.Context) (string, error) {
	if r.user != nil {
		return *r.user, nil
	}
...
type PostgresServerSecurity struct { // postgres (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *Query) Postgres() *Postgres { // postgres (../../../../:0:0)
