...
// A unique identifier for an object.
type QemuMachineID string

// A unique identifier for an object.
type QemuRunResultID string
...
func (r *Query) LoadQemuFromID(id QemuID) *Qemu {
...
func (r *Query) LoadQemuMachineFromID(id QemuMachineID) *QemuMachine {
...
func (r *Query) LoadQemuRunResultFromID(id QemuRunResultID) *QemuRunResult {
...
func (r *Query) LoadZigCiFromID(id ZigCiID) *ZigCi {
...
func (r *Query) LoadZigFromID(id ZigID) *Zig {
...
func (r *Query) LoadZigSectionSizesFromID(id ZigSectionSizesID) *ZigSectionSizes {
