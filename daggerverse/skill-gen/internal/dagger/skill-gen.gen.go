...
func (r *Query) SkillGen() *SkillGen { // skill-gen (../../../../:0:0)
...
type SkillGen struct { // skill-gen (../../../../:0:0)
...
func (r *SkillGen) Postgres(host string, user string, db string, password *Secret, opts ...SkillGenPostgresOpts) *Directory {
