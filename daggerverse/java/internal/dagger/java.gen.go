...
// async I/O.
func (r *Java) Container(source *Directory) *Container {
...
// `gradlew` is present.
func (r *Java) Gradle(source *Directory, opts ...JavaGradleOpts) *JavaGradle {
	assertNotNil("source", source)
...
// is present.
func (r *Java) Maven(source *Directory, opts ...JavaMavenOpts) *JavaMaven {
	assertNotNil("source", source)
...
func (r *Java) Run(ctx context.Context, source *Directory, jar string, opts ...JavaRunOpts) (string, error) {
	assertNotNil("source", source)
	if r.run != nil {
		return *r.run, nil
	}
...
// LTS default.
func (r *Java) ToolVersion(ctx context.Context) (string, error) {
...
func (r *Java) Version(ctx context.Context) (string, error) {
	if r.version != nil {
...
type JavaGradle struct { // java (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *JavaGradle) Assemble() *Directory {
...
func (r *JavaGradle) Build() *Directory {
...
func (r *JavaGradle) Ci() *JavaGradleCi {
	q := r.query.Select("ci")
...
func (r *JavaGradle) Container() *Container {
	q := r.query.Select("container")
...
func (r *JavaGradle) Tasks(ctx context.Context, tasks []string, opts ...JavaGradleTasksOpts) (string, error) {
	if r.tasks != nil {
		return *r.tasks, nil
	}
...
func (r *JavaGradle) Test(ctx context.Context) (string, error) {
	if r.test != nil {
		return *r.test, nil
	}
...
type JavaGradleCi struct { // java (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *JavaGradleCi) Check(ctx context.Context) error {
	if r.check != nil {
		return nil
	}
...
func (r *JavaGradleCi) Run() *Directory {
	q := r.query.Select("run")
...
func (r *JavaGradleCi) WithCheck() *JavaGradleCi {
...
func (r *JavaGradleCi) WithTest() *JavaGradleCi {
...
type JavaMaven struct { // java (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *JavaMaven) Ci() *JavaMavenCi {
	q := r.query.Select("ci")
...
func (r *JavaMaven) Compile() *Directory {
...
func (r *JavaMaven) Container() *Container {
	q := r.query.Select("container")
...
func (r *JavaMaven) Goals(ctx context.Context, goals []string, opts ...JavaMavenGoalsOpts) (string, error) {
	if r.goals != nil {
		return *r.goals, nil
	}
...
func (r *JavaMaven) Package(opts ...JavaMavenPackageOpts) *Directory {
...
func (r *JavaMaven) Test(ctx context.Context) (string, error) {
	if r.test != nil {
		return *r.test, nil
	}
	q := r.query.Select("test")
...
func (r *JavaMaven) Verify(ctx context.Context) (string, error) {
	if r.verify != nil {
		return *r.verify, nil
	}
...
// JDK inference, and cache mounts are inherited.
type JavaMavenCi struct { // java (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *JavaMavenCi) Check(ctx context.Context) error {
	if r.check != nil {
		return nil
	}
	q := r.query.Select("check")
...
// skipped).
func (r *JavaMavenCi) Run() *Directory {
	q := r.query.Select("run")
...
func (r *JavaMavenCi) WithTest() *JavaMavenCi {
	q := r.query.Select("withTest")
...
func (r *JavaMavenCi) WithVerify() *JavaMavenCi {
...
func (r *Query) Java(opts ...JavaOpts) *Java { // java (../../../../:0:0)
