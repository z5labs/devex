...
// Load a Java from its ID.
func (r *Query) LoadJavaFromID(id JavaID) *Java {
	q := r.query.Select("loadJavaFromID")
	q = q.Arg("id", id)
...
// Load a JavaMaven from its ID.
func (r *Query) LoadJavaMavenFromID(id JavaMavenID) *JavaMaven {
	q := r.query.Select("loadJavaMavenFromID")
	q = q.Arg("id", id)
