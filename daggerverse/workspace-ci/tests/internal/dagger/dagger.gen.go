...
// Load a WorkspaceCi from its ID.
func (r *Query) LoadWorkspaceCiFromID(id WorkspaceCiID) *WorkspaceCi {
	q := r.query.Select("loadWorkspaceCiFromID")
	q = q.Arg("id", id)
