...
type WorkspaceCiOpts struct {
	...
	MemoStore WorkspaceCiMemoStore
...
func (r *Query) WorkspaceCi(opts ...WorkspaceCiOpts) *WorkspaceCi { // workspace-ci (../../../../:0:0)
...
type WorkspaceCi struct { // workspace-ci (../../../../:0:0)
...
func (r *WorkspaceCi) AffectedModules(ctx context.Context, base string, head string, callingWorkspace *Workspace, opts ...WorkspaceCiAffectedModulesOpts) (string, error) {
...
// at.
func (r *WorkspaceCi) Generated(ctx context.Context, callingWorkspace *Workspace) error {
	assertNotNil("callingWorkspace", callingWorkspace)
	if r.generated != nil {
		return nil
	}
...
func (r *WorkspaceCi) MemoStoreSelfTest(ctx context.Context) error {
...
// directory makes one.
func (r *WorkspaceCi) Plan(ctx context.Context, base string, head string, callingWorkspace *Workspace, opts ...WorkspaceCiPlanOpts) (string, error) {
	assertNotNil("callingWorkspace", callingWorkspace)
	if r.plan != nil {
		return *r.plan, nil
	}
...
// and rejected.
func (r *WorkspaceCi) RecordPass(ctx context.Context, hash string, ref string, commit string) (string, error) {
	if r.recordPass != nil {
...
// every leg set.
func (r *WorkspaceCi) SelectionSelfTest(ctx context.Context) error {
...
type WorkspaceCiFormat string // workspace-ci (../../../../:0:0)
...
const (
	...
	WorkspaceCiFormatGithubActions WorkspaceCiFormat = "GITHUB_ACTIONS"

	// FormatJSON is the canonical form: an indented JSON array of legs.
	WorkspaceCiFormatJson WorkspaceCiFormat = "JSON"
	...
	WorkspaceCiFormatJenkins WorkspaceCiFormat = "JENKINS"
)
...
type WorkspaceCiMemoStore string // workspace-ci (../../../../:0:0)
...
const (
	...
	WorkspaceCiMemoStoreActionsCache WorkspaceCiMemoStore = "ACTIONS_CACHE"
	...
	WorkspaceCiMemoStoreGitRefs WorkspaceCiMemoStore = "GIT_REFS"
)
