...
func (r *OpentofuConfig) Apply(opts ...OpentofuConfigApplyOpts) *Directory { // opentofu (../../../../../daggerverse/opentofu/config.go:484:1)
...
type OpentofuConfigDestroyOpts struct {
	...
	//
	Targets []string // opentofu (../../../../../daggerverse/opentofu/config.go:527:2)
}
...
// untouched.
func (r *OpentofuConfig) Destroy(opts ...OpentofuConfigDestroyOpts) *Directory { // opentofu (../../../../../daggerverse/opentofu/config.go:523:1)
...
func (r *OpentofuConfig) Format() *Directory { // opentofu (../../../../../daggerverse/opentofu/config.go:292:1)
...
func (r *OpentofuConfig) Init() *Directory { // opentofu (../../../../../daggerverse/opentofu/config.go:345:1)
...
type OpentofuConfigLockOpts struct {
	...
	//
	Platforms []string // opentofu (../../../../../daggerverse/opentofu/config.go:372:2)
}
...
func (r *OpentofuConfig) Lock(opts ...OpentofuConfigLockOpts) *Directory { // opentofu (../../../../../daggerverse/opentofu/config.go:367:1)
...
// (`tofu output -json`).
func (r *OpentofuConfig) Outputs(ctx context.Context) (string, error) { // opentofu (../../../../../daggerverse/opentofu/config.go:561:1)
	if r.outputs != nil {
...
type OpentofuConfigPlanOpts struct {
	...
	//
	Destroy bool // opentofu (../../../../../daggerverse/opentofu/config.go:413:2)
	//
	// Limit the plan to these resource addresses (`-target`).
	//
	Targets []string // opentofu (../../../../../daggerverse/opentofu/config.go:416:2)
}
...
func (r *OpentofuConfig) Plan(opts ...OpentofuConfigPlanOpts) *Directory { // opentofu (../../../../../daggerverse/opentofu/config.go:409:1)
...
// (`tofu show`).
func (r *OpentofuConfig) Show(ctx context.Context) (string, error) { // opentofu (../../../../../daggerverse/opentofu/config.go:569:1)
	if r.show != nil {
		return *r.show, nil
	}
...
// their schemas.
func (r *OpentofuConfig) Validate(ctx context.Context) error { // opentofu (../../../../../daggerverse/opentofu/config.go:315:1)
	if r.validate != nil {
		return nil
	}
