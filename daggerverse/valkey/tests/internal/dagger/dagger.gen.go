...
// A unique identifier for an object.
type ValkeyServerSecurityID string
...
// Load a ValkeyClient from its ID.
func (r *Query) LoadValkeyClientFromID(id ValkeyClientID) *ValkeyClient {
	q := r.query.Select("loadValkeyClientFromID")
	q = q.Arg("id", id)
...
// Load a ValkeyClientSecurity from its ID.
func (r *Query) LoadValkeyClientSecurityFromID(id ValkeyClientSecurityID) *ValkeyClientSecurity {
	q := r.query.Select("loadValkeyClientSecurityFromID")
	q = q.Arg("id", id)
...
// Load a Valkey from its ID.
func (r *Query) LoadValkeyFromID(id ValkeyID) *Valkey {
	q := r.query.Select("loadValkeyFromID")
	q = q.Arg("id", id)
...
// Load a ValkeyServer from its ID.
func (r *Query) LoadValkeyServerFromID(id ValkeyServerID) *ValkeyServer {
	q := r.query.Select("loadValkeyServerFromID")
	q = q.Arg("id", id)
...
// Load a ValkeyServerSecurity from its ID.
func (r *Query) LoadValkeyServerSecurityFromID(id ValkeyServerSecurityID) *ValkeyServerSecurity {
	q := r.query.Select("loadValkeyServerSecurityFromID")
	q = q.Arg("id", id)
