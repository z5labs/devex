...
func (r *Query) Z5Labs() *Z5Labs { // z5labs (../../../../:0:0)
...
func (r *Z5Labs) App(version string) *Z5LabsAppBuilder {
...
// check of its own.
func (r *Z5Labs) ComposeSelfTest(ctx context.Context) error {
...
// It runs in process and needs no container, so it is cheap enough to be a
// check of its own.
func (r *Z5Labs) ContributedTreeSelfTest(ctx context.Context) error {
...
// It runs in process and needs no container, so it is cheap enough to be a
// check of its own.
func (r *Z5Labs) ContributionPathSelfTest(ctx context.Context) error {
...
func (r *Z5Labs) DirectoryDocument(dir *Directory, name string, opts ...Z5LabsDirectoryDocumentOpts) *File {
...
func (r *Z5Labs) FileDocument(file *File, opts ...Z5LabsFileDocumentOpts) *File {
...
func (r *Z5Labs) Go(source *Directory) *Z5LabsGoChain {
...
// It runs in process and needs no container, so it is cheap enough to be a
// check of its own.
func (r *Z5Labs) ImageConfigSelfTest(ctx context.Context) error {
...
func (r *Z5Labs) ImageSbomSelfTest(ctx context.Context) error {
...
func (r *Z5Labs) SourceRedactionSelfTest(ctx context.Context) error {
...
// It runs in process and needs no container, so it is cheap enough to be a
// check of its own.
func (r *Z5Labs) VariantSetSelfTest(ctx context.Context) error {
...
// publishes there.
func (r *Z5Labs) VersionTagsSelfTest(ctx context.Context) error {
...
type Z5LabsApp struct { // z5labs (../../../../:0:0)
	query *querybuilder.Selection
...
// theirs.
func (r *Z5LabsApp) Container(platform Platform) *Container {
...
// Container.
func (r *Z5LabsApp) Containers(ctx context.Context) ([]Container, error) {
...
func (r *Z5LabsApp) Publish(ctx context.Context, repositories []string) ([]string, error) {
...
func (r *Z5LabsApp) WithApp(from *Z5LabsApp) *Z5LabsApp {
...
func (r *Z5LabsApp) WithDirectory(path string, dir *Directory, document *File) *Z5LabsApp {
	assertNotNil("dir", dir)
...
// directory.
func (r *Z5LabsApp) WithFile(path string, file *File, document *File) *Z5LabsApp {
	assertNotNil("file", file)
	assertNotNil("document", document)
...
func (r *Z5LabsApp) WithInsecure() *Z5LabsApp {
...
// nothing.
func (r *Z5LabsApp) WithOidc(requestUrl string, requestToken *Secret) *Z5LabsApp {
...
func (r *Z5LabsApp) WithOidcService(svc *Service) *Z5LabsApp {
...
func (r *Z5LabsApp) WithRegistry(address string, username string, auth *Secret) *Z5LabsApp {
...
func (r *Z5LabsApp) WithRegistryService(svc *Service) *Z5LabsApp {
	assertNotNil("svc", svc)
...
func (r *Z5LabsApp) WithSessionSigstore(fulcio *Service, rekor *Service) *Z5LabsApp {
...
// be supplying a key.
func (r *Z5LabsApp) WithSigningKey(key *Secret) *Z5LabsApp {
...
type Z5LabsAppBuilder struct { // z5labs (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *Z5LabsAppBuilder) Build() *Z5LabsApp {
...
func (r *Z5LabsAppBuilder) WithVariant(platform Platform, entry *File, document *File, opts ...Z5LabsAppBuilderWithVariantOpts) *Z5LabsAppBuilder {
...
type Z5LabsGoChain struct { // z5labs (../../../../:0:0)
	query *querybuilder.Selection
...
func (r *Z5LabsGoChain) App(version string, opts ...Z5LabsGoChainAppOpts) *Z5LabsApp {
	q := r.query.Select("app")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *Z5LabsGoChain) Ci(ctx context.Context) error {
	if r.ci != nil {
		return nil
	}
	q := r.query.Select("ci")
...
func (r *Z5LabsGoChain) WithBuild(tags []string) *Z5LabsGoChain {
...
func (r *Z5LabsGoChain) WithLint(opts ...Z5LabsGoChainWithLintOpts) *Z5LabsGoChain {
...
// caller states it.
func (r *Z5LabsGoChain) WithTest(race bool) *Z5LabsGoChain {
