...
// A unique identifier for an object.
type EnvoyClusterID string

// A unique identifier for an object.
type EnvoyEndpointID string

// A unique identifier for an object.
type EnvoyHTTPConnectionManagerID string

// A unique identifier for an object.
type EnvoyHTTPFilterID string

// A unique identifier for an object.
type EnvoyID string

// A unique identifier for an object.
type EnvoyListenerID string

// A unique identifier for an object.
type EnvoyProxyID string

// A unique identifier for an object.
type EnvoyRouteConfigID string

// A unique identifier for an object.
type EnvoyRouteID string

// A unique identifier for an object.
type EnvoyServerSecurityID string

// A unique identifier for an object.
type EnvoyTCPProxyID string

// A unique identifier for an object.
type EnvoyUpstreamSecurityID string
...
func (r *Query) LoadEnvoyClusterFromID(id EnvoyClusterID) *EnvoyCluster {
...
func (r *Query) LoadEnvoyEndpointFromID(id EnvoyEndpointID) *EnvoyEndpoint {
...
func (r *Query) LoadEnvoyFromID(id EnvoyID) *Envoy {
...
func (r *Query) LoadEnvoyHTTPConnectionManagerFromID(id EnvoyHTTPConnectionManagerID) *EnvoyHTTPConnectionManager {
...
func (r *Query) LoadEnvoyHTTPFilterFromID(id EnvoyHTTPFilterID) *EnvoyHTTPFilter {
...
func (r *Query) LoadEnvoyListenerFromID(id EnvoyListenerID) *EnvoyListener {
...
func (r *Query) LoadEnvoyProxyFromID(id EnvoyProxyID) *EnvoyProxy {
...
func (r *Query) LoadEnvoyRouteConfigFromID(id EnvoyRouteConfigID) *EnvoyRouteConfig {
...
func (r *Query) LoadEnvoyRouteFromID(id EnvoyRouteID) *EnvoyRoute {
...
func (r *Query) LoadEnvoyServerSecurityFromID(id EnvoyServerSecurityID) *EnvoyServerSecurity {
...
func (r *Query) LoadEnvoyTCPProxyFromID(id EnvoyTCPProxyID) *EnvoyTCPProxy {
...
func (r *Query) LoadEnvoyUpstreamSecurityFromID(id EnvoyUpstreamSecurityID) *EnvoyUpstreamSecurity {
...
func (r *Query) LoadEnvoyVirtualHostFromID(id EnvoyVirtualHostID) *EnvoyVirtualHost {
